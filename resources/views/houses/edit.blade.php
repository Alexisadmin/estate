    ...
    <div class="col-md-12 col-12">
      <div class="card">
        ...
        <div class="card-content">
          <div class="card-body">
            <form class="form form-vertical" method="POST" action="/admin-houses/{{ $house->id }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                @method('PATCH')
              ...
              <div class="form-body">
                <div class="row">
                  <div class="col-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="name" value="{{ $house->name }}" id="" class="form-control">
                     </div>
                     @if ($errors->has('name'))
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      <input type="text" name="surname" value="{{ $house->surname }}" id="" class="form-control">
                    </div>
                  ...
                  <div class="col-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="province" value="{{ $house->province }}" id="" class="form-control">
                   </div>
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <input type="text" name="district" value="{{ $house->district }}" id="" class="form-control">
                  </div>
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <input type="text" name="sector" value="{{ $house->sector }}" id="" class="form-control">
                  </div>
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <input type="text" name="cell" value="{{ $house->cell }}" id="" class="form-control">
                  </div>
                  @if ($errors->has('cell'))
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <input type="text" name="village" value="{{ $house->village }}" id="" class="form-control">
                  </div>
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <input type="number" name="telephone" value="{{ $house->telephone }}" id="" class="form-control">
                  </div>
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <input type="text" name="email" value="{{ $house->email }}" id="" class="form-control">
                  </div>
                  @if ($errors->has('email'))
                ...
                <div class="col-md-6">
                   ...
                   <div class="form-group">
                    ...
                    <select name="housing_type" id="" class="form-control ">
                        <option value="{{ $house->housing_type }}">{{ $house->housing_type}}</option>
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <input type="number" name="bedroom" value="{{ $house->bedroom }}" id="" class="form-control">
                  </div>
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <input type="number" name="bathroom" value="{{ $house->bathroom }}" id="" class="form-control">
                  </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                      <input type="number" name="salon" value="{{ $house->salon }}" id="" class="form-control">
                    </div>
                    @if ($errors->has('salon'))
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                     <select name="nearest_city" class="form-control select2">
                        <option value="{{ $house->nearest_city }}">{{ $house->nearest_city }}</option>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                     <select name="nearest_road" class="form-control select2">
                        <option value="{{ $house->nearest_road }}"  class="text-success">{{ $house->nearest_road }}</option>
                        <option value="Yes">Yes</option>
                        <option value="No">No</option>
                     </select>
                    </div>
                  ...
                  <div class="form-group">
                    <input type="number" name="price" value="{{ $house->price }}" id="" class="form-control">
                  </div>
                  @if ($errors->has('price'))
                  ...
                  <div class="col-6">
                    ...
                    <textarea name="description" id="" class="form-control">{{ $house->description }}</textarea>
                    </div>
