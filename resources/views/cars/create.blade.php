...
<div class="row">
  ...
  <div class="col-xxl">
    <div class="card mb-4">
      ...
      <div class="card-body">
        <form class="form form-vertical" method="POST" action="/admin-cars" enctype="multipart/form-data">
            {{ csrf_field() }}
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <div class="input-group input-group-merge">
                ...
                <input type="text" name="car_name" class="form-control" placeholder="Rava4">
              </div>
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <div class="input-group input-group-merge">
                <span id="basic-icon-default-fullname2" class="input-group-text"><i class="bx bx-car"></i></span>
                <input type="text" name="plate" class="form-control" placeholder="RAE100C">
              </div>
              @if ($errors->has('plate'))
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <div class="input-group input-group-merge">
                ...
                <input type="text"name="owner" id="basic-icon-default-company" class="form-control">
              </div>
              @if ($errors->has('owner'))
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <div class="input-group input-group-merge">
                <span id="basic-icon-default-message2" class="input-group-text"><i class="bx bx-building"></i></span>
                <input type="text" name="district" class="form-control" placeholder="Gasabo" aria-label="" aria-describedby="basic-icon-default-building"/>
              </div>
