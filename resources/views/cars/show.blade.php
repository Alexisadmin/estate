...
<head>
  ...
  <title>Easy Estate Rwanda- Cars</title>
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="{{  asset('uploads/' . $car->front_image) }}" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="{{  asset('uploads/' . $car->side_image) }}" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="{{  asset('uploads/' . $car->view_1) }}" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="{{  asset('uploads/' . $car->view_2) }}" alt="">
                </div>
              </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="house">House</a></li>
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="#">Buying plot</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Selling plot</a></li>
