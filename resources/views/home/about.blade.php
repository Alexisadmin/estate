    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto active" href="{{ route('about-us') }}">about-us</a></li>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-xl-5 col-lg-6 d-flex justify-content-center video-box align-items-stretch position-relative">
            <a href="https://www.youtube.com/watch?v=aChnK9iv3Ts" class="glightbox play-btn mb-0"></a>
          </div>
      ...
      <div class="container">
        ...
        <div class="row counters position-relative">
          ...
          <div class="col-lg-3 col-6 text-center">
            ...
            <p>To provide accurate and up-to-date information
              skilled analysis and sound real estate advice</p>
          </div>
          ...
          <div class="col-lg-3 col-6 text-center">
            ...
            <p>To continually explore new ideas and
              ...
              real estate faster, less costly, and easie</p>
          </div>

          <div class="col-lg-3 col-6 text-center">
            <span data-purecounter-start="0" data-purecounter-end="4" data-purecounter-duration="1" class="purecounter"></span>
            <p>To build our country together</p>
          </div>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <p>
                 ...
                 With Easy Estate Rwanda, move to what moves you!
