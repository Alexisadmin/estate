...
<head>
  ...
  <title>Contact - Easy Estate Rwanda</title>
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto active" href="{{ route('contact-us') }}">Contact</a></li>
      ...
      <div class="container">
          ...
          <div class="col-lg-4">
            <div class="info">
              ...
              <div class="email">
                ...
                <h4>Email:</h4>
                <p>customer@easyestaterwanda.com</p>
              </div>

              <div class="phone">
                <i class="bi bi-phone"></i>
                <h4>Call:</h4>
                <p>+250787812489 / +8613207970914 </p>
              </div>
          ...
          <div class="col-lg-8 mt-5 mt-lg-0">
            ...
            <form action="#" method="post" role="form" class="php-email-form">
              ...
              <small class="text-success">This service is comming soon</small>
