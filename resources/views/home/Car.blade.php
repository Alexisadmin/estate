      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          {{-- <li class="dropdown"><a href="#"><span>Admin</span> <i class="bi bi-chevron-down"></i></a>
            <ul>             
              <li class="dropdown"><a href="{{6
                . route('login') }}"><span>Login</span> <i class="bi bi-lock"></i></a>
              </li>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            <h4>Useful Links</h4>
            <ul>            
              <li><a class="bx bx-chevron-right "  href="{{ url('/') }}">Home</a></li>
              <li><a class="bx bx-chevron-right " href="{{ route('plot') }}">Plots</a></li>
              <li><a class="bx bx-chevron-right " href="{{ route('house') }}">house</a></li>
              <li><a class="bx bx-chevron-right active " href="{{ route('cars') }}">Cars</a></li>
              <li><a class="bx bx-chevron-right" href="{{ route('about-us') }}">about-us</a></li>
              <li><a class="bx bx-chevron-right" href="{{ route('contact-us') }}">Contact</a></li>
