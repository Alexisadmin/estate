          ...
          <li class="nav-item navbar-dropdown dropdown-user dropdown">
            <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
              <div class="avatar avatar-online">
                <img src="{{ asset('assets/img/logo/us.jpg') }}" alt class="w-px-40 h-auto rounded-circle">
              </div>
            </a>
                ...
                <a class="dropdown-item" href="javascript:void(0);">
                  <div class="d-flex">
                    <div class="flex-shrink-0 me-3">
                      <div class="avatar avatar-online">
                        <img src="{{ asset('assets/img/logo/user.png') }}" alt class="w-px-40 h-auto rounded-circle">
                      </div>
                    </div>
                    <div class="flex-grow-1">
                      <span class="fw-semibold d-block">  
                       @if(!@empty(Auth::User()->name))
                        {{Auth::User()->name }} 
                      @endif  </span>
                      <small class="text-muted"> @if(!@empty(Auth::User()->email))
                        {{Auth::User()->email }} 
                      @endif </small>
                    </div>
                  </div>
