    ...
    <div class="col-md-12 col-12">
      <div class="card">
        ...
        <div class="card-content">
          <div class="card-body">
            <form class="form form-vertical" method="POST" action="/admin-plots/{{ $plot->id }}" enctype="multipart/form-data">
                @method('PATCH')
                {{ csrf_field() }}
              ...
              <div class="form-body">
                <div class="row">
                  <div class="col-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="name" value="{{ $plot->name }}" id="" class="form-control">
                     </div>
                     @if ($errors->has('name'))
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      <input type="text" name="surname" value="{{ $plot->surname }}" id="" class="form-control">
                    </div>
                  ...
                  <div class="col-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="province" value="{{ $plot->province}}" id="" class="form-control">
                   </div>
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <input type="text" name="district" value="{{  $plot->district }}" id="" class="form-control">
                  </div>
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <input type="text" name="sector" value="{{ $plot->sector }}" id="" class="form-control">
                  </div>
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <input type="text" name="cell" value="{{ $plot->cell }}" id="" class="form-control">
                  </div>
                  @if ($errors->has('cell'))
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <input type="text" name="village" value="{{  $plot->village}}" id="" class="form-control">
                  </div>
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <input type="text" name="telephone" value="{{  $plot->telephone}}" id="" class="form-control">
                  </div>
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <input type="text" name="email" value="{{  $plot->email}}" id="" class="form-control">
                  </div>
                  @if ($errors->has('email'))
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <input type="text" name="width" value="{{  $plot->width}}" id="" class="form-control">
                  </div>
                  @if ($errors->has('width'))
